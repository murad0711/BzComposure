...
const Invoice = () => {
  ...
  const onBtnCancelContainerClick = useCallback(() => {
    navigate("/invoice");
  }, [navigate]);

  return (
    <div className="relative bg-whitesmoke w-full h-[67.5rem] overflow-hidden text-left text-[0.88rem] text-grayapa-500 font-text-sm-leading-5-font-normal">
      ...
      <div className="absolute top-[4.75rem] left-[0.94rem] rounded-lg bg-white shadow-[0px_4px_32px_rgba(0,_0,_0,_0.04)] w-[58.81rem] h-[49.69rem] overflow-hidden flex flex-col p-[2rem] box-border items-start justify-between text-dimgray">
        ...
        <div className="flex flex-col items-start justify-start gap-[1.5rem] text-center text-[0.94rem] text-grayapa-500">
          ...
          <div className="w-[54.81rem] flex flex-row items-center justify-between text-left text-[1rem] text-black">
            ...
            <div className="w-[27.75rem] h-[3.5rem] flex flex-row items-start justify-start gap-[1.5rem] text-[0.88rem] text-darkslateblue">
              <div className="self-stretch flex-1 rounded bg-lightcyan flex flex-row py-[0.5rem] px-[1rem] items-center justify-start border-[1px] border-solid border-cadetblue">
                <div className="flex flex-row items-center justify-start gap-[1rem] text-[1rem]">
                  <img
                    className="relative rounded-lg w-[1rem] h-[1rem] overflow-hidden shrink-0"
                    alt=""
                ...
                <div className="flex-1 relative leading-[1.25rem] text-center hidden">
                  <span className="font-medium">$29 / mo</span>
                  <span className="text-primaryapa-600"> ($290 / yr)</span>
                </div>
                <div className="flex-1 relative leading-[1.25rem] text-primaryapa-600 text-right hidden">
                  Up to 5 active job postings
                </div>
              </div>
              <div className="self-stretch flex-1 rounded bg-white flex flex-row py-[0.5rem] px-[1rem] items-center justify-start text-grayapa-500 border-[1px] border-solid border-grayapa-200">
                <div className="flex flex-row items-center justify-start gap-[1rem] text-[1rem]">
          ...
          <div className="self-stretch flex flex-row items-center justify-end gap-[1.75rem] text-[0.88rem] text-darkslategray">
            <div className="flex flex-row items-center justify-start gap-[0.5rem] text-left">
              <div className="relative leading-[1.25rem]">Received Amount:</div>
              <div className="rounded-md bg-white shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] box-border w-[11.38rem] overflow-hidden shrink-0 flex flex-row py-[0.56rem] px-[0.81rem] items-center justify-start text-[1rem] text-gray-900 border-[1px] border-solid border-grayapa-300">
                <div className="relative leading-[1.5rem]">$1300</div>
              </div>
            </div>
            <div className="flex flex-row items-start justify-start gap-[0.5rem]">
              <div className="relative capitalize">Change:</div>
              <div className="relative text-[1rem] uppercase font-medium text-black text-right">
                $100
              </div>
            </div>
            <div className="hidden flex-row items-start justify-start gap-[1.5rem] text-[0.94rem] text-grayapa-500">
              <div className="relative capitalize">{`Payment Amount `}</div>
              <div className="relative text-[1rem] uppercase font-medium text-black text-right">
                $1200
              </div>
            </div>
      ...
      <div className="absolute top-[4.75rem] left-[60.81rem] rounded-lg bg-white shadow-[0px_4px_32px_rgba(0,_0,_0,_0.04)] w-[58rem] h-[49.69rem] overflow-hidden flex flex-row p-[2rem] box-border items-start justify-end gap-[1.5rem]">
      ...
      <div className="absolute bottom-[0rem] left-[0rem] bg-white w-[120rem] flex flex-row py-[1rem] px-[0rem] box-border items-center justify-center text-[1rem] text-white">
        <div className="w-[40.44rem] flex flex-row items-start justify-start gap-[1.5rem]">
          <div
            className="flex-1 rounded-md bg-cadetblue flex flex-row p-[1rem] items-center justify-center gap-[0.63rem] cursor-pointer"
            onClick={onBtnCancelContainerClick}
          >
            <img
              className="relative w-[1.5rem] h-[1.5rem] overflow-hidden shrink-0"
              alt=""
